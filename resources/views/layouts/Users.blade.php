        ...
        <div class="content-wrapper">
          ...
          <table class="table table-striped ">
            ...
            <tbody>
              ...
              @if (Auth::user()->user_type == 'admin' )
              <td> <button><a href="{{ route('delete.user',$user->id ) }}"><i class="fas fa-trash-alt"></i></a></button></td>
              <td> <button><a href="{{ route('update.user',$user->id ) }}"><i class="fas fa-edit"></i></a></button></td>
              @endif
            </tr>
            @endforeach
