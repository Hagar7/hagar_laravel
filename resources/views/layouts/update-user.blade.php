          ...
          <!-- /.content-header -->
            ...
            <table class="table">
              ...
              <form action="{{ route('edit.user',$user->id) }}" method="Post">
                  ...
                  <td><input type="text" placeholder="Email" name ="email" value= '{{$user->email }}'></td>

                  <td><input type="text" placeholder="Password" name ="password" value='{{$user->password  }}'></td>

                  <td><select placeholder="choose" name="user_type" value= '{{$user->user_type }}' class="form-control">
                      <option>Admin</option>
                      <option>User</option>
